...
const Surety = () => {
    ...
    const handleSearch = async(e) => {
        ...
        try{
            ...
            const response = await api.get("api/bail/petition/details/", { params: searchForm})
            if(response.status === 200){
                                                        ...
                                                        <div className="form-group row">
                                                            <div className="col-sm-12">
                                                                ...
                                                                >
                                                                    ...
                                                                    { cases.map((c, index) => (
                                                                    <option value={c.petition.cino}><span className="text-danger">{c.petition.cino}</span> - { c.petitioner.map((p, index) => (
