...
const JudgeForm = () => {
    ...
    const handleSubmit =  async(e) => {
        ...
        try{
            ...
            const payload = {
                ...form,
                jocode: `${form.state_code}${form.jocode}`,
            ...
            const response = await api.post("base/judge/", payload)
