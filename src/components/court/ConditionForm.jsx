                        ...
                        <div className="row mt-4">
                            <div className="col-md-6 offset-md-1">
                                <div className="form-group row">
                                    <label htmlFor="" className="col-sm-4">Crime Number <RequiredField /></label>
                                ...
                                <div className="form-group row">
                                    <label htmlFor="" className="col-sm-4">Accused Name <RequiredField /></label>
                                ...
                                <div className="form-group row">
                                    <label htmlFor="" className="col-sm-4">Condition Date <RequiredField /></label>
                                    <div className="col-sm-8">
                                        <input 
                                            type="date" 
                                ...
                                <div className="form-group row">
                                    <label htmlFor="" className="col-sm-4">Condition Time <RequiredField /></label>
                                    <div className="col-sm-8">
                                        <input 
                                            type="text" 
                                ...
                                <div className="form-group row">
                                    <label htmlFor="" className="col-sm-4">Accused Present?</label>
                                    <div className="col-sm-8">
                            ...
                            <div className="col-md-4">
                                { form.is_present && (
                                    <React.Fragment>
                                        <div className="form-group row">
                                            <label htmlFor="" className="col-sm-6">Capture Fingerprint</label>
                                        ...
                                        <div className="form-group row mt-2">
                                            <label htmlFor="" className="col-sm-6">Capture Photo</label>
