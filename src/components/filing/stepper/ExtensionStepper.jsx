        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active" aria-current="page">{t('extension')}</li>
                </ol>
            </nav>
            <div id="stepper1" className="bs-stepper">
                <div className="bs-stepper-header mb-3">
                    ...
                    <React.Fragment key={index}>
                        ...
                        >
                        <NavLink
                            to={`/filing/time-extension/${step.path}`}
...
export default ExtensionStepper