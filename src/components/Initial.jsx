...
const Initial = () => {
    ...
    const handleFetchFir = async(e) => {
        e.preventDefault()
        try{
            setLoading(true)
            setShowAdditionalFields(false)
            const response = await api.post("external/police/tamilnadu/fir-details/", data);
            if (response.status === 200) {
        ...
        <div className="container mt-5">
            ...
            <div className="form-group row mb-4">
                ...
                <div className="col-md-4">
                    <Select 
                        ...
                        options={policeDistricts.filter(d=>parseInt(d.revenue_district)===parseInt(petition.district)).map((district) => { return { 
                        ...
                        onChange={(e) => setPetition({...petition, pdistrict:e.value})}
                    />
                    <div className="invalid-feedback">
                        { errors.pdistrict }
                    </div>
                ...
                <div className="col-md-4">
                    <Select 
                        ...
                        options={policeStations.filter(p=>parseInt(p.district_code)===parseInt(petition.pdistrict)).map((station) => { return { 
            ...
            <div className="form-group row mb-4">
                ...
                <div className="col-md-5">
                    ...
                    { showAdditionalFields && (<FIRDetails/>)}
                </div>
            </div>
            </React.Fragment>
            )}
